CREATE FUNCTION gds.get_salle_id(un_nom_de_salle character varying(250)) 
RETURNS bigint AS $$
...
CREATE FUNCTION gds.insert_reservation(
    ...
    un_nom_de_salle character varying(250) 
        ...
        VALUES (nextval('gds.reservation_seq'),une_date_debut, une_date_fin, now(), now(), gds.get_salle_id(un_nom_de_salle)) 
        returning *;
$$ LANGUAGE SQL;